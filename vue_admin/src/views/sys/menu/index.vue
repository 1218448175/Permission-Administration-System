...
const handleDelete = async (id) => {
  let res = await requestUtil.del("menu/action", id)
...
<template>
  <div class="app-container">
    ...
    >
      ...
      </el-table-column><el-table-column prop="date" label="Date" sortable />
      <el-table-column prop="name" label="Name" sortable />
      <el-table-column prop="address" label="Address" sortable />
    </el-table>

    <Dialog v-model="dialogVisible" :dialogVisible="dialogVisible" :id="id" :tableData="tableData" :dialogTitle="dialogTitle"
